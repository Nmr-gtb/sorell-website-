          ...
          <div className="footer-bottom-right">
            ...
            >
              <svg
                ...
                onMouseEnter={(e) => { (e.currentTarget as SVGSVGElement).style.fill = "rgba(255,255,255,0.6)"; }}
                onMouseLeave={(e) => { (e.currentTarget as SVGSVGElement).style.fill = "rgba(255,255,255,0.3)"; }}
              >
