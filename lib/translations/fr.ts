const fr: Record<string, string> = {
  ...
  "social.testimonial1": "« Je passais mes lundis matin à scroller Google Actualités pour suivre mon secteur. Maintenant c'est dans ma boîte mail quand j'arrive au bureau. Simple et efficace. »",
  "social.testimonial1_name": "Marc Tessier",
  "social.testimonial1_role": "Gérant, Tessier Immobilier",
  "social.testimonial2": "« J'ai configuré Sorell pour mon équipe de 6 personnes. Tout le monde reçoit le même résumé chaque mardi. On en parle en réunion, ça a changé nos échanges. »",
  "social.testimonial2_name": "Anne-Claire Duval",
  "social.testimonial2_role": "Directrice des opérations, Groupe Verdier",
