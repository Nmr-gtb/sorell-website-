...
/**
 * La liste des articles arrive en props depuis le Server Component parent
 * (app/blog/page.tsx), qui filtre les articles pas encore publiés. Elle n'est
 * plus importée directement ici : sinon le filtre par date serait évalué dans
 * le navigateur, et le HTML pré-rendu servi à Googlebot contiendrait les
 * articles programmés.
 */
export default function BlogListClient({ articles }: { articles: BlogArticle[] }) {
  const [search, setSearch] = useState("");
  const [activeTag, setActiveTag] = useState<string | null>(null);

  // Tags uniques, triés par fréquence d'apparition.
